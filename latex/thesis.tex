...
\titlepage{IoT Anomaly Detection System using Unsupervised Machine Learning and Multi-Stage Data Pipeline}{ 251054}{Professional Masters in Information Technology}
{Information Technology}{may 2026}
...
%\dedicationpage{Dedicated to my parents and teachers.}


%Optional declaration page (Page ii)
\startdeclarationpage
\input{FrontMatter/declaration}
\label{declaration}


%Optional Certificate page (Page iii)
\startcertificatepage
\input{FrontMatter/certificate}
\label{Certificate}


%Optional Board of Examiners page (Page iv)
\startboardofexaminerspage
\input{FrontMatter/BoardOfExaminers}
\label{BoardOfExaminers}
...
\begin{tabular}{p{2.5cm}p{10cm}}
$s$ & Anomaly score \\
$E(h(x))$ & Expected path length in Isolation Forest \\
$c(n)$ & Average path length of unsuccessful search in BST \\
$w$ & Normal vector to the hyperplane \\
$\xi_i$ & Slack variables for soft margin SVM \\
$\rho$ & Offset of the hyperplane from the origin \\
$\nu$ & Regularization parameter for One-Class SVM \\
$k$ & Number of clusters in K-Means \\
$\mu_i$ & Centroid of cluster $i$ \\
$J$ & Objective function for K-Means clustering \\
