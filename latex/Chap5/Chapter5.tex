...
\begin{figure}[!ht]
\centering
\subfigure[Isolation Forest]{\includegraphics[width=0.31\textwidth]{if_cm}}
\subfigure[K-Means]{\includegraphics[width=0.31\textwidth]{km_cm}}
\subfigure[One-Class SVM]{\includegraphics[width=0.31\textwidth]{oc_cm}}
...
\begin{enumerate}
    \item Quickly identifying which station (\texttt{RmsStationId}) was failing.
    \item Exporting filtered anomaly lists into \texttt{.xlsx} format for management reporting.
    \item The use of color-coded badges (Green/Amber/Red) allowed for ``at-a-glance'' status monitoring of network health.
\end{enumerate}
